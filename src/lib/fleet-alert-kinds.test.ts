...
describe("ຊະນິດຂອງແຈ້ງເຕືອນລົດ", () => {
  ...
  // ສາຂາທີ່ບໍ່ໄດ້ປັກໝຸດສາງ ຈຸດທຽບເຫຼືອແຕ່ພິກັດລູກຄ້າ → ລົດຈອດຢູ່ລານສາງເອງ
  // ຖືກວັດວ່າ "ຫ່າງ 4–15 ກມ" ແລ້ວເຕືອນຜິດທັງມື້.
  it("ອອກນອກເສັ້ນທາງ ນັບສະເພາະສາຂາທີ່ປັກໝຸດສາງແລ້ວ", () => {
    expect(src).toContain("JOIN public.odg_tms_geofence gf0");
  });
