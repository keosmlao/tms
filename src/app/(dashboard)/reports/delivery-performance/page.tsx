    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 2xl:grid-cols-2">
        ...
        <LeadTimePanel
          ...
          footnote="ວັນນັດມາຈາກທີ່ຜູ້ຈັດຖ້ຽວນັດໄວ້ (ຖ້າບໍ່ມີຈຶ່ງໃຊ້ວັນຈັດສົ່ງຂອງຖ້ຽວທຳອິດ) ແລະ ທຽບຈາກ 00:00 ຂອງວັນນັ້ນ — ສົ່ງພາຍໃນວັນທີ່ນັດ = ບໍ່ເກີນ 24 ຊົ່ວໂມງ. ວັນນັດທີ່ວັດແມ່ນ ນັດຄັ້ງທຳອິດ ທີ່ຜູ້ຈັດຕັ້ງໄວ້ (ນິຍາມດຽວກັບໜ້າຫຼັກ ແລະ BI) ບິນທີ່ຖືກເລື່ອນນັດຈຶ່ງບໍ່ກາຍເປັນທັນເວລາຟຣີ — ອ່ານຄູ່ກັບ 'ເລື່ອນນັດຫຼາຍກວ່າ 2 ຄັ້ງ' ຂ້າງລຸ່ມ."
        />
      </div>
